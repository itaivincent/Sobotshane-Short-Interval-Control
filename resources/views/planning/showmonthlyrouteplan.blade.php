...
<div class="layout-px-spacing">
   ...
   <div class="row" id="cancel-row">
                ...
                <a href="/planning/confirmplan/{{$routeplan->id}}"  class="shadow-none badge badge-success"  data-original-title="Edit"><span class="shadow-none badge badge-success">View Total Capability</span></a>
               </div>
   </div>
